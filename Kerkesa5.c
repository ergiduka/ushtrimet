...
/* Funksioni numer  , i kerkon perdoruesit informacion per nje artikull te
ri dhe me pas e refuzon e artikullin ri nese numri (kodi) i tij  esht numer
nje shifror  dhe  kthen mesazhin vler e palejuar  ose kthen  nje mesazh gabimi
nese artikulli egzistonte qe me pare ose nese databaza eshte plot */
...
void numer  (void) {
    ...
    if (artikull_nr < 10 && artikull_nr > -1) {
        printf("Kodi vler e palejuar.\n");
        return;
    }
    ...
    if (inventari[nr_artikull].gjendja == 0) {
        printf("Gjendje e pamjaftueshme.\n");
        return;
    }
